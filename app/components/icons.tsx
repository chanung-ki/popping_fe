...
export const IconMinus = ({ color, width, height }: SVGTypes) => {
  return (
    <SVG
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg">
      <line y1="0.5" x2="7" y2="0.5" stroke={color ?? "#222222"} />
    </SVG>
  );
}
...
export const IconPlus = ({ color, width, height }: SVGTypes) => {
  return (
    <SVG
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg">
      <line y1="3.5" x2="7" y2="3.5" stroke={color ?? "#222222"} />
      <line x1="3.5" y1="0" x2="3.5" y2="7" stroke={color ?? "#222222"} />
    </SVG>
  );
}
...
export const IconCheck = ({ color, width, height }: SVGTypes) => {
  return (
    <SVG
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg">
      <path d="M3.33333 7L0 4L1.11111 3L3.33333 5L8.88889 0L10 1L3.33333 7Z" fill={color ?? "#222222"} />
    </SVG>
  );
}
